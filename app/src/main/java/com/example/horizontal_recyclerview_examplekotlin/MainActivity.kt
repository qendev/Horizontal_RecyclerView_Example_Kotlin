...
import com.example.horizontal_recyclerview_examplekotlin.adapter.TheAdapter
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //reffrencing the recyclerview using its id
        val recycler = findViewById<RecyclerView>(R.id.myRecyclerView)

        //setting recyclerview to horizontal scroll
        ...
        recycler.adapter = TheAdapter(data)
